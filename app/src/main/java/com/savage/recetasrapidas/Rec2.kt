...
import com.savage.recetasrapidas.databinding.ActivityRec2Binding

class Rec2 : AppCompatActivity() {
    private lateinit var biding: ActivityRec2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        biding = ActivityRec2Binding.inflate(layoutInflater)
    ...
    private fun elab(){
        biding.pasos.setOnClickListener{
            val elabint: Intent = Intent(this, prep2:: class.java)
