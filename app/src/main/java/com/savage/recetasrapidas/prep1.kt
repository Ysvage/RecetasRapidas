...
import com.savage.recetasrapidas.databinding.ActivityPrep1Binding

class prep1 : AppCompatActivity() {
    private lateinit var biding: ActivityPrep1Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        biding = ActivityPrep1Binding.inflate(layoutInflater)
    ...
    private fun elab(){
        biding.regresar.setOnClickListener{
            val elabint: Intent = Intent(this, Rec1:: class.java)
