...
import com.savage.recetasrapidas.databinding.ActivityPrep2Binding

class prep2 : AppCompatActivity() {
    private lateinit var biding: ActivityPrep2Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        biding = ActivityPrep2Binding.inflate(layoutInflater)
    ...
    private fun elab(){
        biding.regresar.setOnClickListener{
            val elabint: Intent = Intent(this, Rec2:: class.java)
